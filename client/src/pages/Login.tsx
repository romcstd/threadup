...
const Login = () => {
  ...
  return (
    <>
      <section className="flex h-dvh sm:h-screen min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6" onSubmit={formOnSubmit}>
            <div>
